...
- Linux official entry: `bash work/scripts/bootstrap.sh --work-dir work --code-dir code`
- Windows development entry: `powershell -ExecutionPolicy Bypass -File work/scripts/bootstrap.ps1 -WorkDir work -CodeDir code`
- Linux smoke test: `bash work/scripts/smoke-test.sh --work-dir work --code-dir code`
- Windows smoke test: `powershell -ExecutionPolicy Bypass -File work/scripts/smoke-test.ps1 -WorkDir work -CodeDir code`
