---
description: "LoopForge stage worker for Drift Analysis. Use only when delegated by the parent orchestrator."
mode: subagent
permission:
  edit: deny
  bash: allow
...
output_artifact: "SOURCE_ROOT/.loopforge/consistency/03-drift-report.md"
