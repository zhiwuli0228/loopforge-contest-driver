...
REQUIRED_SUBAGENT_FILES = [
    ...
    "work/subagent/c2r-05a-implement.md",
    "work/subagent/c2r-05b-unit-test.md",
...
class LoopForgeRunner:
    ...
    def _write_agent_delegation_report(self, packet: AgentTaskPacket, analysis: Dict[str, Any], context_pkg: Dict[str, Any]) -> Dict[str, Any]:
        ...
        output_lines = [
            ...
            "Phase 3 (spec)         → Subagent c2r-03-spec.md × sub-batches → specs/*/spec-part-N.md",
            "Phase 4 (plan)         → Subagent c2r-04-plan.md → tasks.md + implement-plan.md + test-migration",
            "Phase 5a (implement)   → Subagent c2r-05a-implement.md × N batches → src/**/*.rs",
            "Phase 5b (unit-test)   → Subagent c2r-05b-unit-test.md × N batches → tests/<cap>_tests.rs",
            "Phase 6 (test)         → Subagent c2r-06-test.md → integration tests",
