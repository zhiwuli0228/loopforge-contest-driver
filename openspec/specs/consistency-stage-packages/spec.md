...
## Purpose
Define the ten stage package assets, file-based handoff rules, gate preservation behavior, executable repair boundary, and partial-result finalization contract for design-implementation consistency execution.
## Requirements
