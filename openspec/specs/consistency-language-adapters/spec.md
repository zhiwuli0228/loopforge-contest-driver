# consistency-language-adapters Specification

## Purpose
Define deterministic language-adapter selection, Java-first extraction, Generic fallback extraction, and the canonical adapter output contract for design-implementation consistency analysis.
