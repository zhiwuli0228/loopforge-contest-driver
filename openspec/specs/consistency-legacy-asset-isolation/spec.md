# consistency-legacy-asset-isolation Specification

## Purpose
Ensure retained C2Rust-era assets stay available for historical inspection without remaining part of the authoritative design-implementation consistency workflow.
