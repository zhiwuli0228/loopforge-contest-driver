...
## Purpose
Define the authoritative repair-aware runtime command surface, structured artifact outputs, verification-status contract, and final report rendering behavior for design-implementation consistency checks.
## Requirements
