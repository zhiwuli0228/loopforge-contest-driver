# consistency-runtime-reporting Specification

## Purpose
Define the authoritative analyze-only runtime command surface, structured artifact outputs, verification-status contract, and final report rendering behavior for design-implementation consistency checks.
